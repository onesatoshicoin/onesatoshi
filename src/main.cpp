...
#if defined(NDEBUG)
# error "OneSatoshiCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OneSatoshiCoin Signed Message:\n";
...
=======
    ...
    if(pindexPrev->nHeight >= 10000){
        nStakeMinConfirmations = 120;
        nStakeMinAge =   (60*60)*3; // 3 hours
>>>>>>> be696e523819e9658ff420defd8ace329e75c2ff
...
=======
    ...
    if(pindexPrev->nHeight == 0)
        return (1000000000 * COIN); // PREMINE
    else if(pindexPrev->nHeight == 1)
        return (958819 * COIN); // TESTS
    else if(pindexPrev->nHeight == 2)
        return (41181 * COIN); //  BILLS 
>>>>>>> be696e523819e9658ff420defd8ace329e75c2ff
    return nFees;
...
if(nHeight >= Params().LastPOWBlock())
{
    ...
    if (nHeight >= Params().LastPOWBlock() && GetBlockTime() > FutureDrift((int64_t)vtx[0].nTime, nHeight))
...
{
    RenameThread("onesatoshicoin-loadblk");
